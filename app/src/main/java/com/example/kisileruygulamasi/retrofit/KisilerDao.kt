...
import com.example.kisileruygulamasi.data.entity.CRUDAnswer
...
interface KisilerDao {
    ...
    @FormUrlEncoded
    suspend fun kisiAra(@Field("kisi_ad") aramaText : String) : KisilerCevap

    @POST("kisiler/insert_kisiler.php")
    @FormUrlEncoded
    suspend fun kaydet(@Field("kisi_ad") kisi_ad :String,
                       @Field("kisi_tel") kisi_tel : String) : CRUDAnswer

    @POST("kisiler/delete_kisiler.php")
    @FormUrlEncoded
    suspend fun sil(@Field("kisi_id") kisi_id :Int) : CRUDAnswer
